...
<p>Amit Sharma built the "Summarize PDFs" app as a free app. This SERVICE is provided by Amit Sharma at no cost and is intended
    for use as is.</p>
...
<p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
    which is accessible at "Summarize PDFs", unless otherwise defined in this Privacy Policy.</p>
